...
```bash
# Crea ambiente conda
conda create -n spindle-detection python=3.8
conda activate spindle-detection
...
```bash
python autoencoder_psd.py
python autoencoder_CI_psd.py
python autoencoder_CI_sovra_psd.py
```

### Clustering Diretto

```bash
python clustering_no_ae.py
```
