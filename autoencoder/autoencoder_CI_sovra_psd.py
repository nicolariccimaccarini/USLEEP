...
images_path = os.path.join(dirData, "images", "canali_individuali_sovrapposizione")
weights_path = os.path.join(dirData, "model", "canali_individuali_sovrapposizione")
...
for file in filenames:
    if file.endswith('.edf'):  # Controlla se il file ha estensione .edf
        ...
        step = int(segment_length * (1 - overlap))
        segments = segment_signal_with_overlap(raw.get_data(), segment_length,step)
